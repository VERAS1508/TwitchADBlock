(function() {
    ...
    function isWorkerIntact() {
        ...
        const intact = cleanWindow && cleanWindow.Worker.toString() === window.Worker.toString();
        iframe.remove();
        return intact;
    }
    declareOptions(window);
    if (!isWorkerIntact()) {
        console.log('[Twitch AdBlock] Another Twitch ad blocker is already active. Skipping VAFT.');
        return;
    }
    hookWindowWorker();
    hookFetch();
